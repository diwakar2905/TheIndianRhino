    ...
    <>
      ...
      <main className="flex-grow bg-white py-[100px] min-h-[60vh] flex flex-col items-center justify-center">
        <div className="max-w-[700px] mx-auto px-8 text-center">
          <FadeIn>
            <h1 className="font-serif text-[40px] tracking-[0.15em] uppercase mb-8 text-black">Sustainability</h1>
            <p className="font-sans text-[16px] text-dark-gray leading-[1.8]">
              Small batches. Ethical production. Minimal waste. We believe luxury should not come at the cost of the environment.
            </p>
          </FadeIn>
        </div>
      </main>
